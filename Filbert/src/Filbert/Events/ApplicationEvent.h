...
namespace Filbert
{
	...
	public:
		...
		inline std::pair<unsigned int, unsigned int> GetResolution() const { return { m_width, m_height }; }
	...
	public:
		...
		inline std::pair<float, float> GetCoordinates() const { return { m_x, m_y }; }
		inline float GetWidth() const { return m_x; }
		inline float GetHeight() const { return m_y; }
